  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_45_577}>
        <View style={styles.View_I45_577_12_9}>
          <Text style={styles.Text_I45_577_12_9}>About UBO</Text>
        </View>
      </View>
      <View style={styles.View_45_578}>
        <View style={styles.View_I45_578_12_9}>
          <Text style={styles.Text_I45_578_12_9}>
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("45_509"))
        }
      >
        <View style={styles.View_45_580} />
        <View style={styles.View_45_581}>
          <Text style={styles.Text_45_581}>next</Text>
        </View>
      </TouchableOpacity>
      <View style={styles.View_45_583}>
        <Text style={styles.Text_45_583}></Text>
      </View>
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_179_4596}
      />
      <View style={styles.View_45_584}>
        <View style={styles.View_I45_584_12_141}>
          <View style={styles.View_I45_584_12_142}>
            <View style={styles.View_I45_584_12_143} />
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/f017/180b/5ad32115e745e732d6d68b43f01e3ee1"
              }}
              style={styles.ImageBackground_I45_584_12_144}
            />
            <View style={styles.View_I45_584_12_145} />
          </View>
          <View style={styles.View_I45_584_12_146}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/4fee/9e86/92da37511c5df705e82285af379e3659"
              }}
              style={styles.ImageBackground_I45_584_12_147}
            />
          </View>
          <View style={styles.View_I45_584_12_151}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/a60f/13cf/1b8dc0b1c1e531d5aaff2f6b97a471f0"
              }}
              style={styles.ImageBackground_I45_584_12_152}
            />
          </View>
        </View>
        <View style={styles.View_I45_584_12_157}>
          <View style={styles.View_I45_584_12_158}>
            <Text style={styles.Text_I45_584_12_158}>9:27</Text>
          </View>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I45_584_12_144: {
  ...
  ImageBackground_I45_584_12_147: {
  ...
  ImageBackground_I45_584_12_152: {
